...
<div class="container ">
    <form action="../model/db_room.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group list-group form-select-lg link-light">
            <label>Hôtel :</label>
            <select name="hotel" class=" form-control link-dark mt-3">
        ...
        <div class="form-group link-light mt-3">
            ...
            <input type="text" class="form-control mt-3"  name="room_number" >
        </div>
 
        <div class="form-group link-light mt-3">
            <label>Room Price :</label>
            <input type="text" class="form-control mt-3" name="room_price" >
        </div>
 
        <div class="form-group link-light mt-3">
            <label>Persons :</label>
            <input type="number" class="form-control mt-3" name="person" >
        </div>
        ...
        <button type="submit" id="bouton" class="btn btn-primary mt-5 mb-5 border-success-subtle bg-secondary" name="add_room" value="submit">Submit</button>
    </form>
</div>
